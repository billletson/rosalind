...
problems.prob_corr()
assert filecmp.cmp("answer.txt", "sample_answers/CORR.txt")
problems.prob_kmer()
assert filecmp.cmp("answer.txt", "sample_answers/KMER.txt")
problems.prob_lexv()
...
problems.prob_edta()
assert filecmp.cmp("answer.txt", "sample_answers/EDTA.txt")
problems.prob_aspc()
